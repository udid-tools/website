...
- Protect `main`; require pull requests, CODEOWNER review for sensitive files, conversation resolution, signed commits, linear history, and the CI, CodeQL, dependency-review, npm-audit, and Scorecard checks.
